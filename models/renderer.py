...
import numpy as np
import mcubes
from models.feat_utils import get_feat_loss
...
class NeuSRenderer:
    ...
    def render_core(self,
        ...
        # [N_rays, N_inside], where N_inside == n_sample+n_importance
        batch_size, n_samples = z_vals.shape
        ...
        if model_input is not None:      
            ...
            # feat_loss
            feat_loss = get_feat_loss(point_surface_wmask, None, model_input['feat'].unsqueeze(0),
                                        model_input['cam'].unsqueeze(0), model_input['feat_src'].unsqueeze(0), model_input['src_cams'].unsqueeze(0),
                                        model_input['size'].unsqueeze(0), model_input['center'].unsqueeze(0), network_mask.reshape(-1),
    ...
    def render(self, rays_o, rays_d , near, far, perturb_overwrite=-1, background_rgb=None, cos_anneal_ratio=0.0, model_input = None, depth_from_inside_only=False, object_mask_type="zero_sdf_mask"):

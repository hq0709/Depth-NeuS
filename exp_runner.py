...
class Runner:
    ...
    def train(self):
        ...
        for iter_i in tqdm(range(res_step)):
            data ,sample = self.dataset.gen_random_rays_at(image_perm[self.iter_step % len(image_perm)], self.batch_size)
...
if __name__ == '__main__':
    ...
    if args.mode == 'train':
        runner.train()
        runner.validate_mesh(world_space=False, resolution=args.volume_resolution, threshold=args.mcube_threshold)
